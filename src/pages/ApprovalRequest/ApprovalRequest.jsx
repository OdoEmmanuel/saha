...
const ApprovalRequest = () => {
    ...
    const downloadExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Approval Request");
        XLSX.writeFile(workbook, "approval-request.xlsx");
    };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6  rounded-[10px]'>
                    ...
                    <div className='md:flex justify-between'>
                        <div className="flex items-center md:w-auto w-full">
                            <select
                                ...
                                className="rounded-[10px] border-2 p-2  md:mr-4 mr-0 md:w-auto w-full"
                            >
                        ...
                        <div className='flex '>
                            <div className='flex items-center justify-end rounded-[5px] border-2 p-2 my-4 md:mx-2 mx-0'>
                                <div>
                                    <IoFilter />
                                </div>
                                <select
                            ...
                            <button onClick={downloadExcel} className='flex justify-between items-center rounded-[5px] border-2 p-2 my-4 md:mx-2 mx-0 md:w-auto w-full md:ml-0 ml-4'>
                                <div className='mr-4'>
                                ...
                                <p className='font-[400] text-[14px] font-inter'>Exports Approval Request</p>
                            </button>
                        </div>
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id="approval-request">
