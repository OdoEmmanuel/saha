                    ...
                    <form className="space-y-4" onSubmit={formik.handleSubmit}>
                        <div className='grid l:grid-cols-3 grid-cols-2 gap-6'>
                            ...
                            <SelectField
                                label="Tenure"
                                name="tenure"
                                options={tenure.map(item => ({
                                    value: item.tenure, // or whatever field holds the value
                                    label: item.description // or whatever field holds the display text
                                }))}
                        ...
                        <button type='submit' onClick={() => console.log('Button clicked', formik.errors, formik.isValid, formik.dirty)}
 className="text-white btn w-full bg-[#072D56] rounded-[10px] px-5 py-2"  > {isLoading ? 'loading....' : 'Create Fixed Deposit'}</button>
                    </form>
                </div>
