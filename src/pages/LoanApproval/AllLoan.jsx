...
const AllLoan = () => {
    ...
    const downloadExcel = () => {
        ...
        const worksheet = XLSX.utils.table_to_sheet(
          document.getElementById("All-Loans")
        );
        XLSX.utils.book_append_sheet(workbook, worksheet, "All Loan Table");
        XLSX.writeFile(workbook, "All-l0ans.xlsx");
      };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6  rounded-[10px]'>
                <div className="sm:flex justify-between">
                    ...
                    <div className='flex sm:w-auto w-full'>
                        ...
                        <button onClick={downloadExcel} className='flex justify-between items-center rounded-[5px] border-2 p-2 my-4 sm:mx-2 mx-0 sm:w-auto w-full sm:ml-0 ml-4'>
                            ...
                            <p className='font-[400] text-[14px] font-inter'>Exports All Loans</p>
                        </button>
                    </div>
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id="All-Loans">
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                                        {filteredUsers.map((staff, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-center text-[16px] font-[400] text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                                    <Tippy content="view">
                                                        <Link
