...
const UpdateGroup = () => {
  ...
  const [fetchCompanyCode, setFetchCompanyCode] = useState('')
  const navigate = useNavigate()

  setHeaders('Update Group')
    ...
    <div className=" bg-gray-100 ">
      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div className="px-6 py-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Update Group</h2>
          <form className="space-y-4" onSubmit={formik.handleSubmit}>
            ...
            <button type='submit' className="text-white btn w-full bg-[#072D56] rounded-[10px] px-5 py-2"  > {isLoading ? 'loading....' : 'Update Group'}</button>
          </form>
        </div>
