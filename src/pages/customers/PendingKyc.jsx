...
const PendingKyc = () => {
    ...
    const downloadExcel = () => {
        ...
        const worksheet = XLSX.utils.table_to_sheet(
            document.getElementById("pending-kyc")
        );
        XLSX.utils.book_append_sheet(workbook, worksheet, "Pending Kyc");
        XLSX.writeFile(workbook, "pending-kyc.xlsx");
    };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6    rounded-[10px]'>
                <div className="sm:flex justify-between ">
                    ...
                    <button onClick={downloadExcel} className='flex justify-between items-center rounded-[5px] border-2 p-2 my-4 mx-2 sm:w-auto w-full '>
                            ...
                            <p className='font-[400] text-[14px] font-inter'>Exports Pending Kyc</p>
                        </button>
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id='pending-kyc'>
