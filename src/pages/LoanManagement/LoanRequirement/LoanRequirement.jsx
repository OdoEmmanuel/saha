...
const LoanRequirement = () => {
    ...
    const downloadExcel = () => {
        ...
        const worksheet = XLSX.utils.table_to_sheet(
            document.getElementById("Loans-requirement")
        );
        XLSX.utils.book_append_sheet(workbook, worksheet, "Loan Requirement Table");
        XLSX.writeFile(workbook, "Loans-requirement.xlsx");
    };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6   rounded-[10px]'>
                    ...
                    <div className="flex  border-2 bg-[#fff] rounded-lg px-4 my-4 items-center  p-2" >
                        ...
                        <div  className='flex justify-between items-center rounded-[5px] border-2 p-1 my-4 mx-2 '>
                            <button className='flex' onClick={downloadExcel}>
                                ...
                                <p className='font-[400] text-[14px] font-inter mr-4'>Exports Loans Requirements</p>
                            </button>
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id="Loans-requirement">
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                                        {filteredUsers.map((staff, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-start  font-medium whitespace-nowrap flex ">
