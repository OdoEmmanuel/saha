...
const LoanPurpose = () => {
    ...
    const downloadExcel = () => {
        ...
        const worksheet = XLSX.utils.table_to_sheet(
            document.getElementById("Loans-purpose")
        );
        XLSX.utils.book_append_sheet(workbook, worksheet, "Loan Purpose Table");
        XLSX.writeFile(workbook, "Loans-purpose.xlsx");
    };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6   rounded-[10px]'>
                    ...
                    <div className='flex'>
                        ...
                        <div  className='flex justify-between items-center rounded-[5px] border-2 p-1 my-4 mx-2 '>
                            <button className="flex " onClick={downloadExcel}>
                                ...
                                <p className='font-[400] text-[14px] font-inter mr-4'>Exports Loans  Purpose</p>
                            </button>
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id="Loans-purpose">
