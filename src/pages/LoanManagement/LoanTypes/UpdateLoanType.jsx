...
const UpdateLoanType = () => {
    ...
    useEffect(() => {
        setisLoading(true)
        axios.get(`${middleware}loan/loanType/${id}`,config)
        .then((res) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            axios.put(`${middleware}loan/loanType/${id}`, values, config)
                .then((res) => {
        ...
        <div className=" bg-gray-100 ">
            ...
            <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
                <div className="px-6 py-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Update Loan Type</h2>
                    <form onSubmit={formik.handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <button
                                ...
                                disabled={isLoading}
                            >
                                {isLoading ? 'updating...' : 'Update Loan Type'}
                            </button>
                        </div>
                    </form>
                </div>
