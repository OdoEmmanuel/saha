     ...
     const { middleware, authorizationService, request, clientid, setHeaders } = useAuthContext()
       ...
       [])
        ...
        const fetchData = () => {
            ...
            axios.get(`${middleware}loan/loanType`, config)
                .then((res) => {
        ...
        const downloadExcel = () => {
            ...
            const worksheet = XLSX.utils.table_to_sheet(
              document.getElementById("Loans-Tenure")
            );
            XLSX.utils.book_append_sheet(workbook, worksheet, "Loan Tenure Table");
            XLSX.writeFile(workbook, "Loans-Tenure.xlsx");
          };
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6  rounded-[10px]'>
                <div className="md:flex justify-between ">
                    ...
                    <div className='flex justify-between items-center rounded-[5px] border-2 p-1 md:my-4 my-2 md:mx-2 mx-0 md:w-auto w-full'>
                            ...
                            <p className='font-[400] text-[14px] font-inter mr-4'>Exports Loans Type</p>
                            <Link
                        to={`/ui/tables/createLoanType`}
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id="Loans-Tenure">
                                        ...
                                        {filteredUsers.map((staff, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-center  font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap flex">
                                                    ...
                                                    <Tippy content="edit">
                                                    <Link
                                                        to={`/ui/tables/updateloanType/${staff.id}`}
