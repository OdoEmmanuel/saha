...
const AllStock = () => {
    ...
    const fetchData = () => {
        axios.get(`${middleware}stock/search?pageNumber=${pageNumber}&pageSize=${pagesize}&searchTerm=${searchQuery}&isAllowed`, config)
            .then((res) => {

                setUsers(res.data.data)
                setTotalPages(res.data.pageMeta.totalPages)
            }).catch((e) => {
    ...
    let idCounter = (pageNumber - 1) * pagesize + 1
            ...
            <div className='bg-[#fff] mt-4 shadow-md overflow-hidden p-6   rounded-[10px]'>
                <div className="sm:flex  justify-between">
                    ...
                    <div className='flex sm:w-auto w-full'>
                        ...
                        {/* <button onClick={downloadExcel} className='flex justify-between items-center rounded-[5px] border-2 p-2 my-4 mx-2 sm:w-auto w-full'>
                            ...
                            <p className='font-[400] text-[14px] font-inter'>Exports All Stocks</p>
                        </button> */}
                         <div  className='flex justify-between items-center rounded-[5px] border-2 p-1 my-4 md:mx-2 mx-0 md:w-auto w-full'>
                                                    <button className='flex' onClick={downloadExcel}>
                                                        ...
                                                        <p className='font-[400] text-[14px] font-inter mr-4'>Exports All Stocks</p>
                                                    </button>
                                                   
                                                    <Link
                                                        to={`/ui/tables/create-stocks/`}
                ...
                <div className="overflow-x-scroll no-scrollbar">
                    <div className="min-w-full inline-block align-middle">
                        <div className="">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 overflow-x-scroll" id='active-customer'>
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-center  font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap flex">
                                                    ...
                                                    <Tippy content="View">
                                                        ...
                                                        <Link
                                                            to={`/ui/tables/View-stocks/${staff.id}/`}
